...
description: "SimpleJpaRepository 클래스에서 delete 메서드 호출 시 삭제 시점에 내부적으로 Entity의 영속 상태를 체크하는 이유가 궁금해서 질문을 남겼는데, 그 과정에서 알게 된 내용을 기록한 글"
author: oxahex
createdAt: 2024-03-20
tags: ["spring", "jpa", "questions"]
---
